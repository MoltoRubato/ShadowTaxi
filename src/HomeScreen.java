/*
 * This class is based on the HomeScreen class from the solution provided for Project 1.
...
public class HomeScreen {
    ...
    public boolean update(Input input) {
        ...
        TITLE_FONT.drawString(TITLE, (double) Window.getWidth() / 2 - TITLE_FONT.getWidth(TITLE)/2, TITLE_Y);
        INSTRUCTION_FONT.drawString(INSTRUCTION, (double) Window.getWidth() / 2 - INSTRUCTION_FONT.getWidth(TITLE)/2,
                INSTRUCTION_Y);
