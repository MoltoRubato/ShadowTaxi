/*
 * This class is based on the Trip class from the solution provided for Project 1.
 * Original code from: Project 1 Solution.
 * Modifications have been made to integrate the Driver with a Trip record.
 */
...
public class Trip {
    ...
    public boolean hasReachedEnd() {
        // can't end trip if passenger is not in a taxi
        if (taxi == null){
            return false;
        }
    ...
    public void end() {
        isComplete = true;
        PASSENGER.setIsGetInTaxi(null, null);
        DRIVER.setTrip(null);
        calculateFee();
    }
