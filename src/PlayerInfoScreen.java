/*
 * This class is based on the PlayerInfoScreen class from the solution provided for Project 1.
...
public class PlayerInfoScreen{
    ...
    public boolean update(Input input) {
        ...
        PI_FONT.drawString(PI_PLAYER_NAME,
                (double) Window.getWidth() / 2 - PI_FONT.getWidth(PI_PLAYER_NAME)/2, PLAYER_NAME_Y);

        PI_FONT.drawString(PI_START_GAME,
                (double) Window.getWidth() / 2 - PI_FONT.getWidth(PI_START_GAME)/2, START_GAME_Y);
        ...
        PI_FONT.drawString(playerName,
                (double) Window.getWidth() / 2 - PI_FONT.getWidth(playerName)/2, PLAYER_NAME_INPUT_Y, FONT_STYLE);
